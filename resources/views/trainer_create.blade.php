...
<head>
    ...
    <title>Tambah Pelatih Manual</title>
    <style>
...
<div class="form-container">
    <h2>Tambah Data Pelatih Baru</h2>
    ...
    <form action="{{ route('trainer.store') }}" method="POST">
        ...
        <div class="form-group">
            <label for="name">Nama Lengkap Pelatih:</label>
        ...
        <button type="submit" class="btn-submit">Simpan Pelatih</button>
